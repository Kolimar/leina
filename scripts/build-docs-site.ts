...
const PAGES: PageDef[] = [
  ...
  { id: "usage-guide", section: "guides", nativeLang: "en", en: p("docs/guides/usage-guide.md"), es: p("docs/i18n/es/usage-guide.md") },
  { id: "cli-reference", section: "reference", nativeLang: "en", en: p("docs/CLI_REFERENCE.md"), es: p("docs/i18n/es/cli-reference.md") },
  { id: "concepts-readme", section: "concepts", nativeLang: "en", en: p("docs/concepts/README.md"), es: p("docs/i18n/es/concepts/README.md") },
  { id: "concepts-01-arquitectura", section: "concepts", nativeLang: "en", en: p("docs/concepts/01-arquitectura.md"), es: p("docs/i18n/es/concepts/01-arquitectura.md") },
  { id: "concepts-02-grafo", section: "concepts", nativeLang: "en", en: p("docs/concepts/02-grafo.md"), es: p("docs/i18n/es/concepts/02-grafo.md") },
  { id: "concepts-03-busqueda-y-consultas", section: "concepts", nativeLang: "en", en: p("docs/concepts/03-busqueda-y-consultas.md"), es: p("docs/i18n/es/concepts/03-busqueda-y-consultas.md") },
  { id: "concepts-04-memoria", section: "concepts", nativeLang: "en", en: p("docs/concepts/04-memoria.md"), es: p("docs/i18n/es/concepts/04-memoria.md") },
  { id: "concepts-05-comunicacion-grafo-memoria", section: "concepts", nativeLang: "en", en: p("docs/concepts/05-comunicacion-grafo-memoria.md"), es: p("docs/i18n/es/concepts/05-comunicacion-grafo-memoria.md") },
  { id: "concepts-06-hooks-e-inyeccion", section: "concepts", nativeLang: "en", en: p("docs/concepts/06-hooks-e-inyeccion.md"), es: p("docs/i18n/es/concepts/06-hooks-e-inyeccion.md") },
