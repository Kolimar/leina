...
| [`guides/usage-guide.md`](guides/usage-guide.md) | Guided, Q&A-style walkthrough ("what can I ask the AI") + a full SDD walkthrough | Spanish |
| [`CLI_REFERENCE.md`](CLI_REFERENCE.md) | Every command, every flag, what it prints, the implementation entry point | English |
| [`concepts/`](concepts/README.md) | How it works internally — graph, memory, search, drift, hooks — with diagrams | Spanish |
